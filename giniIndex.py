...
def giniIndexFunc(dataset, target):
    global Accuracy
    global Precision
    global Recall
    global F1Score
    ...
    # Accuracy
    Accuracy= round(100 * accuracy_score(Y_test, Y_predGI), 3)
    
    # Precision
    Precision= round(100 * precision_score(Y_test, Y_predGI, average='weighted'), 3)

    # Recall
    Recall= round(100 * recall_score(Y_test, Y_predGI, average='weighted'), 3)
   
    #F1 Score
    F1Score= round(100 * f1_score(Y_test, Y_predGI, average='weighted'), 3)

    #Confusion Matrix
    CM= confusion_matrix(Y_test, Y_predGI)
