...
def storeValues():
    dataset = entry1.get()
    target = entry2.get()
    gradientBoost.gradientBoostFunc(dataset, target)

    Label(text="Result of Gradient Boost Classifier :", bg="black", fg="yellow", font=("Helvetica", 12)).place(
        x=95, y=210)

    # ---------------------------------------------------------------------------------------------------------------

    Label(text="Accuracy", bg="white", fg="black",width= 18, font=("Helvetica", 12)).place(x=95, y=250)
    Label(text=gradientBoost.Accuracy, bg="black", fg="white", font=("Helvetica", 12)).place(x=275, y=250)

    Label(text="Precision", bg="white", fg="black", width=18, font=("Helvetica", 12)).place(x=400, y=250)
    Label(text=gradientBoost.Precision, bg="black", fg="white", font=("Helvetica", 12)).place(x=580, y=250)

    Label(text="Recall", bg="white", fg="black",width=18, font=("Helvetica", 12)).place(x=95, y=300)
    Label(text=gradientBoost.Recall, bg="black", fg="white", font=("Helvetica", 12)).place(x=275, y=300)

    Label(text="F1 Score", bg="white", fg="black", width=18,font=("Helvetica", 12)).place(x=400, y=300)
    Label(text=gradientBoost.F1Score, bg="black", fg="white", font=("Helvetica", 12)).place(x=580, y=300)

    Label(text="Confusion Matrix", bg="white", fg="black", width=18,font=("Helvetica", 12)).place(x=245, y=350)
    Label(text=gradientBoost.CM, bg="black", fg="white", font=("Helvetica", 12)).place(x=300, y=400)
